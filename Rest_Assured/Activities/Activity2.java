...
public class Activity2 {
    ...
    public void AddNewUser() throws IOException {
       ...
       //Import JSON file
        File file = new File("C:\\FSTProject\\FST_RestAssured\\src\\test\\inputActivity2.json");
    ...
    public void GetUser() {
        ...
        Response response=
                given().contentType(ContentType.JSON)
                        .pathParam("username", "kush")// Set headers
        ...
        response.then().body("username", equalTo("kush"));
